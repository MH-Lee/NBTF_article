...
d2v_model_small_name2 = './model/word_embedding/Doc2vec_new_small2_4.model'
doc_vectorizer_small = Doc2Vec.load(d2v_model_small_name2)
doc_vectorizer_small.wv.vectors.shape
doc_vectorizer_small.corpus_count
doc_vectorizer_small.docvecs.doctag_syn0.shape

tag_dict = dict()
for idx, tag in enumerate(doc_vectorizer_small.docvecs.index2entity):
    tag_dict[idx] = tag
...
# filename = './model/ml_model/LR_clf_last6.sav'
...
# filename = './model/ml_model/LR_clf_small_last6.sav'
# pickle.dump(clf, open(filename, 'wb'))
